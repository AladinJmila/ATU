...
public class BankingAppApproveLoanTest {
	...
	@BeforeAll
    static void approveLoanTestsStarted() {
        System.out.println("Approve loan tests started.");
    }
	...
	@AfterAll
    static void approveLoanTestsEnded() {
        System.out.println("Approve loan tests ended.");
    }
}
